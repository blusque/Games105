...
class WalkingController():
    ...
    def build_kargs():
        ...
        '''
        kargs = {
            'motion': r'motion_material\physics_motion\long_walk.bvh'
        }
        return kargs
    ...
    def prepare(self):
        ...
        作为实例我们简单地初始化一下姿势
        '''
        translation, orientation = self.motion.batch_forward_kinematics(frame_id_list=[
                                                                        0])
    ...
    def apply_torque(self):
        ...
        我们这里用的是静态站立力矩
        '''
        torque = part3_cal_static_standing_torque(
            self.motion, self.physics_info)
