...
def part1_skinning_one_frame(viewer, translations, orientations, T_pose, skinning_weight, idx, value, frame_id=0):
    ...
    translation = skinning(translation, orientation,
                           T_pose, init_abs_position, idx, value)
...
def part2_skinning_animation(viewer, translations, orientations, T_pose, skinning_weight, idx, value):
    ...
    animation = Animation(viewer, translations, orientations,
                          T_pose, skinning_weight, idx, value)
...
def main():
    ...
    part2_skinning_animation(viewer, translations,
                             orientations, T_pose, skinning_weight, idx, value)
    viewer.run()
